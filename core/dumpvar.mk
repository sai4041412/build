...
$(info $(CLR_RED)                                                   $(CLR_RST))
$(info $(CLR_RED) XX     XX   TTTTTTTT   NNN      NN   DDDDDDD      $(CLR_RST))
$(info $(CLR_RED)  XX   XX       TT      NNNN     NN   DD     DD    $(CLR_RST))
$(info $(CLR_RED)   XX XX        TT      NN NN    NN   DD      DD   $(CLR_RST))
$(info $(CLR_RED)    XXX         TT      NN  NN   NN   DD      DD   $(CLR_RST))
$(info $(CLR_RED)   XX XX        TT      NN   NN  NN   DD      DD   $(CLR_RST))
$(info $(CLR_RED)  XX   XX       TT      NN    NN NN   DD     DD    $(CLR_RST))
$(info $(CLR_RED) XX     XX      TT      NN     NNNN   DDDDDDD      $(CLR_RST))
$(info $(CLR_RED)                                                   $(CLR_RST))
$(info $(CLR_RED)***************************************************$(CLR_RST))
$(info $(CLR_RED)             Get Ready To Be Xtended               $(CLR_RST))
$(info $(CLR_RED)***************************************************$(CLR_RST))
$(info $(CLR_RED)         Project Xtended by Team-Xtended           $(CLR_RST))
$(info $(CLR_RED)***************************************************$(CLR_RST))
