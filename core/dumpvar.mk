...
$(info $(CLR_RED)      _____           _           _            $(CLR_RST))
$(info $(CLR_RED)     |  __ \         |_|         | |           $(CLR_RST))
$(info $(CLR_RED)     | |__| | __ ___  _  ___  ___| |_          $(CLR_RST))
$(info $(CLR_RED)     |  ___/ .__/ _ \| |/ _ \/ __| __|         $(CLR_RST))
$(info $(CLR_RED)     | |   | | | |_| | |  __/ |__| |_          $(CLR_RST))
$(info $(CLR_RED)     |_|   |_|  \___/| |\___|\___|\__|         $(CLR_RST))
$(info $(CLR_RED)      __   ___      _/ |       _          _    $(CLR_RST))
$(info $(CLR_RED)      \ \ / / |    |__/       | |        | |   $(CLR_RST))
$(info $(CLR_RED)       \ V /| |_ ___ _ __   __| | ___  __| |   $(CLR_RST))
$(info $(CLR_RED)        > < | __/ _ \ ._ \ / _` |/ _ \/ _` |   $(CLR_RST))
$(info $(CLR_RED)       / . \| ||  __/ | | | |_| |  __/ |_| |   $(CLR_RST))
$(info $(CLR_RED)      /_/ \_\\__\___|_| |_|\__,_|\___|\__,_|   $(CLR_RST))
$(info $(CLR_RED)                                               $(CLR_RST))
$(info $(CLR_RED)***********************************************$(CLR_RST))
$(info $(CLR_RED)             Get Ready To Be Xtended           $(CLR_RST))
$(info $(CLR_RED)***********************************************$(CLR_RST))
$(info $(CLR_RED)         MSM Xtended ROM by Team-Xtended       $(CLR_RST))
$(info $(CLR_RED)***********************************************$(CLR_RST))
...
$(info $(CLR_BLU)  $(CLR_BOLD)$(CLR_MAG)XTENDED_VERSION = $(CLR_RED)$(XTENDED_VERSION)$(CLR_RST)$(CLR_RST))
